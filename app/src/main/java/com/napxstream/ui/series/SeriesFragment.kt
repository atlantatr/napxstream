...
import com.napxstream.databinding.FragmentSeriesBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val continueWatchingAdapter = ContinueWatchingAdapter { item ->
            ...
            startActivity(Intent(requireContext(), SeriesDetailActivity::class.java).apply {
                putExtra(Constants.EXTRA_SERIES_ID, sId)
                putExtra(Constants.EXTRA_TITLE, item.title.substringBefore(" - "))
            })
        }
